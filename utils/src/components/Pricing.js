    ...
    <div class="flex flex-wrap -m-4">
      <div class="p-4 xl:w-1/4 md:w-1/2 w-full">
        <div class="h-full p-6 rounded-lg border-2 border-gray-300 flex flex-col relative overflow-hidden">
          ...
          <h1 class="text-5xl  pb-4 mb-4 border-b border-gray-200 leading-none">Free</h1>
          ...
          <button class="flex items-center mt-auto text-white  border-0 py-2 px-4 w-full focus:outline-none hover:bg-gray-500 rounded">Button
